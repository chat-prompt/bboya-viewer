...
> 📖 심화: [봇키우기 교실 #1 — 보안 설정](/notes/bot-school-01-security)
...
- [봇키우기 교실 #4 — 정체성 설계](/notes/bot-school-04-identity) — 에이전트에게 맥락 주기
- [봇키우기 교실 #5 — 멀티에이전트 설계](/notes/bot-school-05-multi-agent) — 여러 에이전트 운영하기
- [공식 문서](https://docs.openclaw.ai/channels/telegram) — 고급 설정 전체 참고
