...
accentColor: "#6366F1"
description: "복자를 터미널 밖 슬랙으로. 앱 매니페스트 한 덩이 + 토큰 두 개로 슬랙 앱 만들고 OpenClaw에 연동, 페어링 후 첫 DM 응답까지."
...
라이브 시작 시점에 복자가 슬랙에 있어야 *400명 시청자가 같이 보는* 라이브가 가능해요. **터미널 밖으로 나오는 순간, 봇은 *진짜 동료*가 돼요.**

이 챕터는 5~15분이면 끝나요. 차 한 잔 준비하고 시작해볼까요? 🐾
