...
봇이 실제로 하는 일:
1. **워크스페이스 생성** — `~/.openclaw/workspace-새봇이름/`
2. **SOUL.md 작성** — 동생의 성격과 역할 정의
3. **AGENTS.md 작성** — 보안/규칙 설정
4. **openclaw.json에 등록** — 시스템이 새 봇을 인식
5. **기존 봇과의 소통 규칙** — 누가 뭘 담당하는지, 보고 체계
...
채널에서 멘션으로 대화하는 것도 가능해. 팀 채널에서는 **Slack 멘션**이 좋아 — 사람이 중간에 교정할 수 있거든.
