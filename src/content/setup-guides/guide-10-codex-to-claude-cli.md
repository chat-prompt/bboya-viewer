...
자세한 변천사는 [ep-00 OpenClaw 변천사](/case-studies/multi-agent/ep-00-journey)에서 풀었어요. 여기선 짧게:
...
- 변천사 맥락이 궁금하면 → [ep-00 OpenClaw 변천사 (토큰 빌려쓰기 → ACP → CLI 정식)](/case-studies/multi-agent/ep-00-journey)
